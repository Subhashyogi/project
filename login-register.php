...
<!-- Mirrored from gnodesign.com/templates/movify/login-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jun 2024 02:27:06 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <div class="small-dialog login-register">
                    ...
                    <div class="signin-wrapper">
                        ...
                        <div class="small-dialog-content">
                            ...
                            <!-- Start of Login form -->
                            <form id="cariera_login" method="post" action="login.php">
                                <p class="status"></p>
                    ...
                    <div class="signup-wrapper">
                        ...
                        <div class="small-dialog-content">
                            ...
                            <form id="cariera_registration" action="registration.php" method="POST">
                                <p class="status"></p>

                                <div class="form-group">
                                    <label for="username">Username</label>
                                    <input name="username" id="User_Name" class="form-control" type="text"/>
                                </div>
                                ...
                                <div class="form-group">
                                    <input type="submit" class="btn btn-main btn-effect nomargin" name="register "value="Register"/>
                                </div>
                            </form>
