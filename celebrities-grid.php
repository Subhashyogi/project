...
<!-- Mirrored from gnodesign.com/templates/movify/celebrities-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jun 2024 02:27:04 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <div class="row mb50">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="layout-switcher">
                            <a href="celebrities-list.html" class="list"><i class="fa fa-align-justify"></i></a>
                            <a href="celebrities-grid.html" class="grid active"><i class="fa fa-th"></i></a>
                        </div>
                    </div>
